...
""")
		while True:
			sys.stdout.write(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"LoveTool"+Color.LC+" @ "+Color.LG+"admin"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
			option = input()
...
""")
		...
		print(Color.LR+"["+Color.LG+"EXIT"+Color.LR+"]"+Color.LC+" TRỞ LẠI")
		print("\n")
		http_proxy = "https://www.viduchung.ml/viduchung"
		while True:
			sys.stdout.write(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"user"+Color.LC+" @ "+Color.LG+"Layer7"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
			option = input()
...
if __name__ == '__main__':
	commands = f"""{Color.LC}Nhập Lệnh: {Color.LY}"layer7" Hoặc "LAYER7" Để Bắt Đầu\n{Color.LC}EXIT: {Color.LY}Thoát\n{Color.LC}STOP: {Color.LY}Ngừng DDoS\n{Color.LC}CONTACT: {Color.LY}Contact/Hỗ Trợ"""
	contact = f"""{Color.LC}Facebook: Color.LYhttps://www.facebook.com/viduchung.06\n{Color.LC}Telegram: Color.LY@viduchung06"""
